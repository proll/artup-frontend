WHP.pages.error404 = {
    ...
    setView : function(_message)
    {
        if (_message == 1)
        {
            this.fm.attr("src", "/gui/failman.png?whp20");
        }else if (_message == 2){
            this.fm.attr("src", "/gui/failman2.png?whp20");
        }else if (_message == 3){
            this.fm.attr("src", "/gui/failman_4.png?whp20");
        }else if (_message == 4){
            this.fm.attr("src", "/gui/failman_5.png?whp20");
        }
